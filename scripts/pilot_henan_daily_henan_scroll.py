#!/usr/bin/env python3
"""河南日报 新闻-河南: scroll down + screenshot."""
...
PREFIX = "hnrb_news_hn"
FOLDER_TAG = "新闻河南"
MARKER_NAME = "latest_henan_news_henan_output_dir.txt"
PACKAGE = "com.hnzx.hnrb"
CAPTURE_KEY = "news_henan_capture"
...
def main() -> int:
    ...
    parser.add_argument("--skip-nav", action="store_true", help="Already on 新闻-河南 page")
    ...
    if not app_in_foreground(adb):
        print(f"Warning: {PACKAGE} may not be in foreground. Open 新闻-河南 and retry.", flush=True)
